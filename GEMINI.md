...
- **Core Skills**: 
  - Use the `richdiary-standard` skill for all development tasks. It contains project-specific templates (ViewModel, ViewController, View) and coding standards (`references/coding-standard.md`).
